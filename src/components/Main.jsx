...
${question}`
  ...
  return (
    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='lg:h-[530px] lg:h-max-[530px] lg:w-[800px]  mt-[80px] lg:mt-[30px] flex flex-col lg:items-center pl-3 pr-3'>
        <h1 className=' text-3xl lg:text-3xl lg:pt-5 text-center font-bold'><span className='text-[#c82217]'>Git</span>Hub Read<span className='text-[#c82217]'>me</span> Generator</h1>
          ...
          <form action="">
            ...
            <textarea type="text" placeholder='Write your code here:' className='lg:h-[377px] lg:w-[750px] h-[550px] w-[370px] text-black mt-2 bg-gray-200 border-2 border-[white]' value={question} onChange={(e) => setQuestion(e.target.value)}/>
          </form>
      </div>
      ...
      <pre onClick={() => setTextToCopy(answer)} className='text-black text-md'>{answer}</pre>
      </div>
      </div>
    </div>
  )
